      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            {/* Header */}
            <div className="mb-8">
              <Link to="/" className="inline-flex items-center space-x-2 text-muted-foreground hover:text-foreground transition-smooth mb-6">
              ...
              <p className="mt-2 text-muted-foreground">
                {isLogin 
                  ? "Sign in to your AgriPredict dashboard" 
          ...
          <div className="relative flex flex-col justify-center h-full px-12 text-white">
            <div className="max-w-md">
              ...
              <p className="text-lg text-primary-foreground/90 mb-8">
                Join thousands of farmers who are already using AgriPredict to increase yields, 
              ...
              <div className="grid grid-cols-2 gap-6 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-primary-foreground/80">Avg. Yield Increase</div>
                </div>
              </div>
